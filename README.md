...
For contrastive learning we can create very large datasets because we have a large database of 4908X3264 microscope images taken by our automated wafer imaging setup. I created a dataset of 117027 200X200 images. The images were generated by identifying regions with color deviation from median above a threshold and cropping a 200X200 square around that region: regions with contrast corresponding to Class 1-3 and outside this range were chosen in equal numbers.
